<?php
	...
	*/
	...
	$result = BD::sql_query("SELECT count(*) as count FROM riesgo	WHERE id IN (SELECT riesgo_id FROM sede_escenario_riesgo WHERE sede_escenario_id IN ( SELECT id	FROM sede_escenario	WHERE sede_id =".$sede_id."))");
...
$query="SELECT id,nombre, (
	...
	SELECT COUNT( * )
	FROM sede_escenario_riesgo
	WHERE riesgo_id = riesgo.id
	AND `sede_escenario_id`
	IN (
