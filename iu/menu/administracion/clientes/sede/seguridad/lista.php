<?php
	...
	if ($sede_id != "")
		$add_query .= "  and descripcion not like '%riesgos operativos%' AND sede_id = ". Seguridad::escapeSQL($sede_id);
	...
	*/
	...
	while ($row = BD::obtenerRegistro($result)) {
		...
		$responce->rows[$i]['cell'] = array (
			...
			utf8_encode("$btnMatriz$btnCopiar<img style='margin:3px;cursor:pointer;' onclick='editarDispositivo(" . $row["id"] . ")' src='imagenes/editar.png' title='Editar'>$btnBorrar")
		);
		$i++;
	}
