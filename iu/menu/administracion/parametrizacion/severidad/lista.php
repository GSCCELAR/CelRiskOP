<?php
	...
	*/
	$campos = array("id", "calificacion","criterio");
	...
	$count = 0;
	$add_query .= " ";
	$result = BD::sql_query("SELECT COUNT(*) AS count FROM mseveridad WHERE 1=1 $add_query");
	...
	$query = "SELECT * FROM mseveridad WHERE 1=1 $add_query ORDER BY $sidx $sord";
