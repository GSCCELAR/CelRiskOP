...
<script type="text/javascript" charset="ISO-8859-1">
	$(document).ready(function() {
		$("#lista").jqGrid({
		    ...
		    datatype : "json",
		    colNames : ['<b>ID</b>', '<b>Nombre</b>', '<b>Descripción</b>', '<b>Costo Anual</b>', '<b>Porcentaje Eficiencia</b>', '<b>Opc</b>'],
		    colModel : [
				...
				{ name:'costo_anual', index:'costo_anual', width:150, align: 'left' },
				{ name:'porcentaje_eficiencia', index:'porcentaje_eficiencia', width:150, align: 'left' },
		    ...
		    sortorder : "asc",
			height: "auto",
		    caption: "<i class='icon-list icon-white' /> <b>CONTROLES</b>"
		});
