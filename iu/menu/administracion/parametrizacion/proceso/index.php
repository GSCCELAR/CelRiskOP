...
<script type="text/javascript" charset="ISO-8859-1">
	$(document).ready(function() {
		$("#lista").jqGrid({
		    ...
		    datatype : "json",
		    colNames : ['<b>ID</b>', '<b>Proceso</b>', '<b>Objetivo</b>', '<b>Alcance</b>', '<b>Opc</b>'],
		    colModel : [
		        { name:'id', index:'id', width:65, align: 'center' },
				{ name:'nombre', index:'nombre', width:150, align: 'left' },
				{ name:'objetivo', index:'objetivo', width:150, align: 'left' },
				{ name:'alcance', index:'alcance', width:150, align: 'left' },
		    ...
		    sortorder : "asc",
			height: "auto",
		    caption: "<i class='icon-list icon-white' /> <b>PROCESOS</b>"
		});
