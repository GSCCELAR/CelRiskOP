<?php
	...
	*/
	...
	$count = 0;
	$add_query .= " ";
	$result = BD::sql_query("select COUNT(*) AS count FROM vdepartamentos WHERE 1=1 $add_query");
	...
	$query = "select * FROM vdepartamentos WHERE 1=1 $add_query ORDER BY $sidx $sord";
