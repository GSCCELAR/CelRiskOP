...
<script type="text/javascript" charset="ISO-8859-1">
	$(document).ready(function() {
		$("#lista").jqGrid({
		    ...
		    datatype : "json",
		    colNames : ['<b>ID</b>', '<b>País</b>', '<b>Departamento</b>', '<b>Opc</b>'],
		    colModel : [
		        { name:'id', index:'id', width:65, align: 'center' },
		        { name:'pais_nombre', index:'pais_nombre', width:150, align: 'left' },
		    ...
		    sortorder : "asc",
			height: "auto",
		    caption: "<i class='icon-list icon-white' /> <b>DEPARTAMENTOS</b>"
		});
	...
	function eliminar(id) {
		jConfirm("Confirma que desea borrar este registro?<br />Nota: Si este registro está relacionado en otra tabla no podrá borrarlo.", "Pregunta", function(r) {
			if (r) {
				showMessage();
